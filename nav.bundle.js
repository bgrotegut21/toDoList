...
/* harmony import */ var date_fns_isThisWeek__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns/isThisWeek */ "./node_modules/date-fns/esm/isThisWeek/index.js");
/* harmony import */ var date_fns_getDayOfYear__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns/getDayOfYear */ "./node_modules/date-fns/esm/getDayOfYear/index.js");
...
2
                ...
                console.log(newTasks, "the current new tasks")
                 ...
                 if  (!(0,date_fns_isThisWeek__WEBPACK_IMPORTED_MODULE_6__["default"])(task.date)) tasks = newTasks;
...
//        //console.log(staticListTasks[index], "static list current index");
    ...
    const sortDatesByLatestDay = (timeTasks) => {
        ...
        newTimeTasks.sort((timeTask1, timeTask2) => {
            let days2 = (0,date_fns_getDayOfYear__WEBPACK_IMPORTED_MODULE_7__["default"])(timeTask2.date);
            let days1 = (0,date_fns_getDayOfYear__WEBPACK_IMPORTED_MODULE_7__["default"])(timeTask1.date);
            return days2 - days1;
        })
        return newTimeTasks;
        ...
        navKeys.forEach(key => {
            ...
            if (key == "upcoming"){
                ...
                navs[key].forEach(task => {
                    ...
                    task.navIndex = "upcoming";
                    task.navName = "Upcoming";
                    if ((0,date_fns_isToday__WEBPACK_IMPORTED_MODULE_8__["default"])(task.date)) todayTasks.push(task)
                    if ((0,date_fns_isThisWeek__WEBPACK_IMPORTED_MODULE_6__["default"])(task.date)) weekTasks.push(task);
                    upcomingTasks.push(task);
       ...
       console.log(staticListTasks, "the static list tasks")
        ...
        deletedUpComingItems.forEach(task => {
            if (task.navIndex == "upcoming"){
                ...
                navs[task.navIndex] = (0,_elementEvents_js__WEBPACK_IMPORTED_MODULE_0__.removeItem)(navTask,task.taskIndex);

            } else {
                let navTask = navs[task.navIndex][task.boardIndex].tasks;
                navs[task.navIndex][task.boardIndex].tasks = (0,_elementEvents_js__WEBPACK_IMPORTED_MODULE_0__.removeItem)(navTask,task.taskIndex);
            }
